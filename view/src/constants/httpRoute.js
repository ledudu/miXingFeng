...
export const HTTP_URL = {
	...
	"getNetEaseCloudMusic": hostname + "/get_net_ease_cloud_music?query={query}",
	"getQQMusic": hostname + "/get_qq_music?query={query}",
	"getKuGouMusic": hostname + "/get_ku_gou_music?query={query}",
	"getOnlineMusic": hostname + "/get_online_music?query={query}",
	"getNetEaseCloudMusicLinksByIds": hostname + "/get_net_ease_cloud_music_links__by_ids?ids={ids}",
	"getQQMusicLinksByIds": hostname + "/get_qq_music_links_by_ids?ids={ids}",
	"getKuGouMusicLinksByIds": hostname + "/get_ku_gou_music_links_by_ids?ids={ids}",
